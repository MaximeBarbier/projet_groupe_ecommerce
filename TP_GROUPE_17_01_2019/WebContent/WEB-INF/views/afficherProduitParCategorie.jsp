...
<body style="background-color: #FFFFF0;">
	...
	<div style="border: 1px black solid; width: 15%; text-align: center; float: left;">
		<ul style="text-align: left; list-style: none; padding-bottom: 100px; padding-top: 80px;">
			<c:forEach items="${categorieAttribute}" var="cat">
				<li style="margin-bottom:15px;"><a style="text-decoration: none; color: black;"
	...
	<div style="width: 50%; margin-left: 350px;">
		<table cellspacing="0" cellpadding="6" border="1" width="50%"
			...
			<c:forEach items="${listProduitAttribute}" var="prod">
				<tr>
